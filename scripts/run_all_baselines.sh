...
RETRIEVAL_MODEL_NAME="${4:-${BASELINE_RETRIEVAL_MODEL_NAME:-/mnt/huawei/ymb/model/models--sentence-transformers--all-MiniLM-L6-v2/snapshots/c9745ed1d9f207416be6d2e6f8de32d1f16199bf}}"
...
for model_alias in "${MODELS[@]}"; do
  for baseline_name in "${BASELINES[@]}"; do
    run_task "model=${model_alias} baseline=${baseline_name}" \
